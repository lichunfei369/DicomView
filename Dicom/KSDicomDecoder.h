...
#define TRANSFER_SYNTAX_UID         0X00020010//传输语法
#define SLICE_THICKNESS             0x00180050  
#define SLICE_SPACING               0x00180088  
#define SAMPLES_PER_PIXEL           0x00280002//像素采样 1为灰度 3为彩色
#define PHOTOMETRIC_INTERPRETATION  0x00280004//图像模式 MONOCHROME2为灰度
#define PLANAR_CONFIGURATION        0x00280006  
#define NUMBER_OF_FRAMES            0x00280008  
#define ROWS                        0x00280010//row高
#define COLUMNS                     0x00280011//col宽
#define PIXEL_SPACING               0x00280030  
#define BITS_ALLOCATED              0x00280100//单个采样数据长度
#define WINDOW_CENTER               0x00281050//窗位
#define WINDOW_WIDTH                0x00281051//窗宽
...
#define PIXEL_DATA                  0x7FE00010//像素数据开始处

#define PATIENT_ID                  0X00100020//患者ID
#define PATIENT_NAME                0X00100010//患者名字
#define PATIENT_SEX                 0X00100040//患者性别
#define PATIENT_AGE                 0X00101010//患者年龄

#define STUDY_INSTANCE_UID          0x0020000d
#define STUDY_ID                    0X00200010
#define STUDY_DATE                  0X00080020//检查日期
